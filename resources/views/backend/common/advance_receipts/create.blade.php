...
@section('title', 'Advance Recept Create')
@push('css')
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Advance Recept Create</h3>
                        ...
                        <div class="card-body">
                            ...
                            $advance_receipt = '';
                            @endphp
                            {!! Form::open(['route' => Request::segment(1) . '.advance-receipts.store', 'method' => 'POST', 'files' => true]) !!}
