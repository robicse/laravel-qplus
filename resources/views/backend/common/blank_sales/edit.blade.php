...
@section('title', 'Blank Sale Update')
@push('css')
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Blank BlankSale </h3>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            {!! Form::model($blankSale, [
                                'route' => [Request::segment(1) . '.blank-sales.update', $blankSale->id],
                                'method' => 'PATCH',
                                'files' => true,
                            ]) !!}
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div id="dynamic" class="row bg-light">
                                        <table class="table table-responsive">
                                            ...
                                            <tbody id="itemlist">
                                                @foreach($blankSaleDetails as  $key => $data)
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <input class="input-sm text-right form-control quantity" type="number"
                                                            ...
                                                            data-format="0[.]00" value="{{ $data->qty }}">
                                                    ...
                                                    <td width="15%">
                                                        <input type="number"
                                                            ...
                                                            min="0" max="9999999999999999" required
                                                            data-format="0[.]00" data-cell="C{{ $index }}" value="{{ $data->sale_price }}">
                                                    </td>
                                                    <td width="15%">
                                                        <input type="text"
                                                            ...
                                                            max="999999999999999" value="{{ $data->total }}">
                                                    </td>
                                                    <td width="15%">
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    @if (count($order_types) > 0)
                                                                        @foreach ($order_types as $order_type)
                                                                            <option value="{{ $order_type->id }}" {{ $order_type->id == $blankSale->payment_type_id ? 'selected':''}}>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number" name="sub_total" id="amount"
                                                                        ...
                                                                        step="any" min="0" max="999999999999" value="{{ $blankSale->sub_total }}">
                                                                </td>
                                                            </tr>
                                                            <tr style="display: none">
                                                                ...
                                                                <td>
                                                                    <select class="form-control" name="discount_type"
                                                                        id="discount_type">
                                                                        <option value="Flat" {{ $blankSale->discount_type == 'Flat' ? 'selected' : '' }}>Flat</option>
                                                                        <option value="Percent" {{ $blankSale->discount_type == 'Percent' ? 'selected' : '' }}>Percent</option>
                                                                    </select>
                                                                </td>
                                                            </tr>
                                                            <tr style="display: none" id="discount_percent_div">
                                                                ...
                                                                <td>
                                                                    <input type="text" name="discount_percent"
                                                                        ...
                                                                        onkeyup="discountCalculation('')" value="{{ $blankSale->discount_percent }}">
                                                                </td>
                                                            </tr>
                                                            <tr style="display: none">
                                                                <th>Total Vat:</th>
                                                                <td>
                                                                    <input type="number" name="total_vat" id="total_vat"
                                                                        ...
                                                                        step="any" min="0"
                                                                        max="9999999999999999" value="{{ $blankSale->total_vat }}">
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input class="input-sm text-right form-control" type="number"
                                                ...
                                                max="99999999999999" required data-format="0[.]00" readonly value="{{ $blankSale->total_quantity }}">
                                        </td>
                                        <td>
...
@push('js')
    ...
    <script>
        ...
        function getval(row, sel) {
            ...
            $.ajax({
                url: "{{ URL(Request::segment(1) . '/blank-blankSale-relation-data') }}",
                method: "get",
                data: {
