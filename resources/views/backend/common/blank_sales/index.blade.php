...
@section("title","Blank Sales Lists")
@push('css')
    <!-- DataTables -->
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">blank sales</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Blank Sale Lists</h3>
                            <div class="float-right">
                                @can('blank-sales-create')
                                {{-- <a href="{{ @url('/backend/demo_xlsx/sale.xlsx') }}"> <button class="btn btn-info">
                                        Download Demo <i class="fa fa-download"></i>
                                    </button></a> --}}
                                <a href="{{route(Request::segment(1).'.blank-sales.create')}}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.data-table').DataTable({
                ...
                ajax: "{{ route(Request::segment(1).'.blank-sales.index') }}",
                columns: [
                    {data: 'id', name: 'id'},
