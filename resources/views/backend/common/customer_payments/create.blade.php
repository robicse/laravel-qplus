            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Customer Refund</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Customer Refund</h3>
                            <div class="float-right">
                                <a href="{{ route(Request::segment(1) . '.customer-payments.index') }}">
                        ...
                        <div class="card-body" id="dynamic">
                            ...
                            @endif
                            {!! Form::open(['route' => Request::segment(1) . '.customer-payments.store', 'class' => 'form', 'id' => 'form']) !!}
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        {!! Form::number('total_due', null, ['id' => 'total_due', 'class' => 'form-control mb-1', 'readonly']) !!}
        ...
        $(document).ready(function() {
            ...
            $('#customer_id').change(function() {
                ...
                if (customer_id) {
                    $.ajax({
                        type: "GET",
                        url: "{{ url(Request::segment(1) . '/customer-return-due-balance-info') }}" + '/' +
                        customer_id,
                        dataType: "JSON",
