...
@section('title', 'Customer Refund Lists')
@push('css')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Customer Refund Lists</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route(Request::segment(1) . '.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Customer Refund Lists</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Customer Refund Lists</h3>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.data-table').DataTable({
                ...
                ajax: "{{ route(Request::segment(1) . '.customer-payments.index') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
