                            ...
                            <div class="row">
                                        ...
                                        <table class="table table-responsive">
                                            ...
                                            <tbody id="itemlist">
                                                <tr>
                                                    ...
                                                    <td width="10%">
                                                        <input type="number" class="input-sm text-right form-control sale_price" placeholder="0.00"
                                ...
                                bottom: 0; z-index: 999;">
                                    ...
                                    <tr>
                                        ...
                                        <th>Paid:</th>
                                        <td id="PaidAmount">
                                            {!! Form::number('paid', null, ['id' => 'paid', 'class' => 'form-control', 'step' => 'any', 'required', 'onkeyup'=>"paidAmount('')"]) !!}
                                        </td>
                                        <th>Due:</th>
                                        <td>
