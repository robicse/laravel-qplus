                            ...
                            <div class="row">
                                                ...
                                                <tr>
                                                    {{-- <td>
                                                        <div>
                                                            <select class="form-control category_id select2"
                                                                name="category_id[]" required id="category_id_{{ $index }}"
                                                    ...
                                                    <td width="15%">
                                                        <select class="form-control product_id select2" name="product_id[]"
                                                            id="product_id_{{ $index }}" onchange="getval({{ $index }},this);" required style="width: 100%">
                                                    ...
                                                    <td width="10%">
                                                        <div>
                                                            <select class="form-control unit_id select2" name="unit_id[]"
                                                                required id="unit_id_{{ $index }}" onchange="getUnitVal({{ $index }},this);" style="width: 100%">
                                                    ...
                                                    <td width="10%">
                                                        <input type="number"
                                                            ...
                                                            name="purchase_price[]" id='buy_price_id_{{ $index }}' step="any"
                                                            min="0" max="9999999999999999" required
                                                            data-format="0[.]00" data-cell="E{{ $index }}" value="{{ $stock->purchase_price }}">
                                                    </td>
                                                    <td width="10%">
                                                        <input type="number"
                                                            ...
                                                            min="0" max="9999999999999999" required
                                                            data-format="0[.]00" data-cell="C{{ $index }}" value="{{ $stock->sale_price }}">
                                                    </td>
                                                    <td width="10%">
                                                        <input type="number" class="form-control input-sm text-right"
                                                            name="product_vat[]" data-cell="V{{ $index }}"
                                                            id='product_vat_id_{{ $index }}' data-format="0[.]00" readonly value="{{ $stock->product_vat }}">
                                                    </td>
                                                    <td width="10%">
                                                        <input class="form-control input-sm text-right" type="number"
                                                            ...
                                                            id='product_vat_amount_id_{{ $index }}' data-format="0[.]00" value="{{ $stock->product_vat_amount }}">
                                                    </td>
                                                    <td width="15%">
                                                        <input type="text"
                                                            class="amount form-control input-sm text-right" name="total[]"
                                                            data-cell="F{{ $index }}" data-format="0[.]00"
                                                            data-formula="(E{{ $index }}*D{{ $index }})" readonly step="any" min="0"
                                ...
                                bottom: 0; z-index: 999;">
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="discount" id="discount_amount"
                                                ...
                                                min="0" max="9999999999999999" value="{{ $purchase->discount_amount}}">
                                        </td>
                                        <th>Total Buy:</th>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <th>Paid:</th>
                                        <td id="PaidAmount">
                                            {!! Form::number('paid', $purchase->paid_amount, ['id' => 'paid', 'class' => 'form-control', 'step' => 'any', 'required', 'onkeyup'=>"paidAmount('')"]) !!}
                                        </td>
                                        <th>Due:</th>
                                        <td>
...
@push('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.addProduct', function(event) {
                ...
                var tr =
                    ...
                    '" step="any" min="0" max="9999999999999999" data-format="0[.]00"></td>' +

                    '<td width="12%"><input type="number" step="any" min="0" max="9999999999999999" class="input-sm text-right form-control purchase_price"  data-format="0[.]00" name="purchase_price[]" id="buy_price_id_' +
            ...
            // real time change
            $('#itemlist').delegate('.quantity, .purchase_price, .sale_price', 'keyup', function () {
                $form = $('#dynamic').calx();
                $form.calx('update');
                $form.calx('getCell', 'G1').setFormula('SUM(F1:F' + 5000 + ')');
                $form.calx('getCell', 'G1').calculate();
        ...
        function buyPriceSum(){
            ...
            if(discount_amount){
                var t = t - parseFloat(discount_amount);
            }
        ...
        function discountCalculation() {
            ...
            if (discount_type == 'Flat') {
                ...
                if (discount_amount !== '') {
                    ...
                    var final_amount = total_sale_price - discount_amount;
                } else {
