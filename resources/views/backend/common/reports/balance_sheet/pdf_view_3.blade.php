    ...
    @if ($balanceSheetReports->isNotEmpty())
        <div style="padding: 1.5rem;">
            <table class="padding text-left small border-bottom">
                ...
                <tbody class="strong">
                    @foreach ($balanceSheetReports as $data)
                        @php
                        ...
                        <tr>
                            ...
                            <td>{{ Helper::getPaymentTypeName(1) }}</td> --}}
        ...
        <div style="padding:0 1.5rem;">
            ...
            {{-- <table style="width: 100%;margin-right:auto;padding-top: 5px;" class="text-right sm-padding small strong pt-2">
                <tbody>
                    <tr>
                        <th class="text-right strong">In Word :{{ucwords($digit->format($balanceSheetReports->sum('amount'),2))}} Only</th>
                    </tr>
                </tbody>
            </table> --}}
        </div>
