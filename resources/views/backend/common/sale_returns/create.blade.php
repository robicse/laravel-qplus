                            ...
                            <div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-8 col-md-8">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <p class="lead">Sale Return Type:</p>
                                                                ...
                                                                <select class="form-control select2"
                                                                    ...
                                                                    @if (count($cash_payment_types) > 0)
                                                                        @foreach ($cash_payment_types as $payment_type_id)
                                                                            <option value="{{ $payment_type_id->id }}">
                                ...
                                bottom: 0; z-index: 999;">
                                    <tr>
                                        ...
                                        <th>Customer Due:</th>
                                        <td>
                                            <input type="number" name="customer_due" id="customer_due"
                                                class="form-control" readonly step="any" min="0"
                                                max="9999999999999999" />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="refundable_amount" id="refundable_amount"
                                                class="form-control" readonly step="any" min="0"
                                                max="9999999999999999" />
                                        </td>
                                        <th>Paid:</th>
...
@push('js')
    ...
    <script>
        ...
        function paidAmount(){
            ...
            var refundable_amount = $("#refundable_amount").val();
            ...
            // }
            var paid_amount = $('#paid').val();
            var due = (total + refundable_amount) - paid_amount;
            $('#due').val(due);
        }
            ...
            $('#sale_id').on('change', function(){
                ...
                $.ajax({
                    ...
                    success: function(res) {
                        ...
                        $("#customer_due").val(res.data.customer_due);
                    },
                    error: function(err) {
                        console.log(err)
                    }
        ...
        function priceCalculation() {
            ...
            if (sale_type_id === '2') {
                console.log(2)
                $('#refundable_amount').prop("readonly", false);
                $("#paid").val(0);
                ...
                if(customer_due > 0){
                    if(customer_due > final_amount){
                        $("#refundable_amount").val(final_amount);
                        $("#paid").val(0);
                    }else{
                        $("#refundable_amount").val(final_amount - customer_due);
                        $("#paid").val(final_amount - customer_due);
                    }
                }else{
                    $("#refundable_amount").val(0);
                }
