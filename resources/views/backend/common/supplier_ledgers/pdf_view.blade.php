...
<body>
    <div style="padding: 1.5rem;">
        ...
        @include('backend.common.reports.report_date_time',['invoice_type'=>'Supplier Ledger Report'])
        @include('backend.common.reports.supplier')
        <table>
            <tr>
        ...
        <div style="padding: 1.5rem;">
            <table class="padding text-left small border-bottom">
                ...
                @if ($supplierReports->isNotEmpty())
                    <tbody class="strong">
                        @foreach ($supplierReports as $data)
                            @php
        ...
        <div style="padding:0 1.5rem;">
            ...
            {{-- <table style="width: 100%;margin-right:auto;padding-top: 5px;" class="text-right sm-padding small strong pt-2">
                <tbody>
                    <tr>
                        <th class="text-right strong">In Word :{{ucwords($digit->format($supplierReports->sum('amount'),2))}} Only</th>
                    </tr>
                </tbody>
            </table> --}}
        </div>
