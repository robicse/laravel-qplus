...
@section('title', 'Supplier Paid Amount')
@push('css')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Supplier Paid Amount</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route(Request::segment(1) . '.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item active">Supplier Paid Amount</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Supplier Paid Amount</h3>
                        ...
                        <div class="card-body" id="dynamic">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label for="date">Paid Now<span class="required"> *</span></label>
        ...
        $(document).ready(function() {
            ...
            $('#supplier_id').change(function() {
                ...
                if (supplier_id) {
                    $.ajax({
                        type: "GET",
                        url: "{{ url(Request::segment(1) . '/supplier-due-amount') }}" + '/' +
                        supplier_id,
                        dataType: "JSON",
