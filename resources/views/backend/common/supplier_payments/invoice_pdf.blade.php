...
<body>
    <div>
        <div style="padding: 1.5rem;">
            ...
            @include('backend.common.reports.date_time',['invoice_type'=>'Money Receipt Invoice'])
        </div>
        <div style="padding: 1.5rem;padding-bottom: 0">
            <table>
                <tr>
                    <td class="strong smallstrong">Supplier Name: {{ @$transactions[0]->supplier->name }}</td>
                </tr>
                <tr>
                    <td class="strong small">Mobile: {{ @$transactions[0]->supplier->phone }}</td>
                </tr>
                <tr>
        ...
        <div style="padding:0 1.5rem;">
            <table style="width: 40%;margin-right:auto;" class="text-left sm-padding small strong">
                <tbody>
                    <tr>
                        <th class="text-left strong">Total Total: {{ number_format(@$transactions->sum('amount'), 2) }} /- taka</td>
                    </tr>
                </tbody>
            </table>
            <table style="width: 100%;margin-right:auto;padding-top: 5px;" class="sm-padding small strong pt-2">
                <tbody>
                    <tr>
                        <th class="text-left strong" style="text-align: left">In Word :{{ucwords($digit->format(@$transactions->sum('amount'),2))}} taka Only</th>
                    </tr>
