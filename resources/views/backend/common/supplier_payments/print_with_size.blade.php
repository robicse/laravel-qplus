            ...
            <div id="printArea">
                ...
                <div class="panel-body">
                    ...
                    <div style="padding:0 1.5rem;">
                        <table style="width: 40%;float: left;" class="sm-padding small strong">
                            <tbody>
                                <tr>
                                    <th class="strong" style="text-align: left">Total Total: {{ number_format(@$transactions->sum('amount'), 2) }} /- taka</td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table style="width: 100%;padding-top: 50px;" class="sm-padding small strong pt-2">
                            <tbody>
                                <tr>
...
<body>
    <div class="main-invoice">
        ...
        <div style="float: left;display: inline-block;">
            ...
            Cust. Name :{{ @$saleReturn->supplier->name }}<br>
